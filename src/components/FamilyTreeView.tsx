...
// Hapus TreeNode, AncestorNode, FamilyMemberLink, DescendantTreeDisplay, AncestorTreeDisplay
// dan fungsi buildDescendantTree, buildAncestorTree karena sudah dipindahkan ke D3FamilyTreeVisualization.tsx
...
export const FamilyTreeView: React.FC = () => {
    ...
    if (!rootIndividual && individualList.length > 0) return <div className="text-center p-8 text-xl text-gray-400">Pilih individu dari daftar di atas.</div>;


    return (
        <div className="w-full h-[calc(100vh-64px)] flex flex-col"> {/* Pastikan ini full height untuk SVG */}
            ...
            <div className="flex-grow w-full h-full overflow-hidden">
                {/* <--- GUNAKAN KOMPONEN VISUALISASI D3 BARU DI SINI ---> */}
